...
1. In the same directory as this readme file, run `cd web-api`. Then run `mvn clean compile spring-boot:run`.
1. Open a second terminal tab or the another integrated VSCode terminal.
1. In the same directory as this readme file, run `cd web-app`. Then run `mvn clean compile spring-boot:run`.
